...
<body>
    ...
    <div class="wrapper">
						...
						<div class="user-box dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-end">
								...
								<li>
									...
									<a class="dropdown-item" href="javascript:;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
								</li>
							</ul>
						</div>
					</nav>
		...
		@include('layouts.absensi.footer')
	</div>
