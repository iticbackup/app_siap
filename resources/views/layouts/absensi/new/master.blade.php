...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/absensi/new/') }}/font/CS-Interface/style.css" />
    <!-- Font Tags End -->
    <!-- Vendor Styles Start -->
    ...
    <link rel="stylesheet" href="{{ asset('public/absensi/new/') }}/css/vendor/glide.core.min.css" />
    <link rel="stylesheet" href="{{ asset('public/absensi/new/') }}/css/vendor/introjs.min.css" />
    <link rel="stylesheet" href="{{ asset('public/absensi/new/') }}/css/vendor/select2.min.css" />
    <link rel="stylesheet" href="{{ asset('public/absensi/new/') }}/css/vendor/select2-bootstrap4.min.css" />
    <link rel="stylesheet" href="{{ asset('public/absensi/new/') }}/css/vendor/plyr.css" />
    <!-- Vendor Styles End -->
...
<body>
            ...
            <div class="nav-content d-flex">
                ...
                <div class="logo position-relative">
                    <a href="{{ route('absensi.home') }}">
                        ...
                        {{-- <div class="img"></div> --}}
                        <div style="color: white; font-weight: bold">ITIC ABSENSI</div>
                    </a>
                </div>
                <!-- Logo End -->
                ...
                <div class="user-container d-flex">
                    <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown"
                        ...
                        <img class="profile" alt="profile" src="{{ asset('public/absensi/new/') }}/img/profile/profile-11.webp" />
                ...
                <div class="menu-container flex-grow-1">
                    <ul id="menu" class="menu">
                        ...
                        <li>
                            <a href="{{ route('ijin_keluar_masuk') }}">
                                <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i>
                                <span class="label">Ijin Keluar Masuk / Ijin Jam Kerja</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('ijin_terlambat') }}">
                                <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i>
                                <span class="label">Ijin Terlambat</span>
                            </a>
                        </li>
                        {{-- <li>
    ...
    <script src="{{ asset('public/absensi/new/') }}/js/vendor/Chart.bundle.min.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/vendor/chartjs-plugin-datalabels.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/vendor/chartjs-plugin-rounded-bar.min.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/vendor/glide.min.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/vendor/intro.min.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/vendor/select2.full.min.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/vendor/plyr.min.js"></script>
    ...
    <script src="{{ asset('public/absensi/new/') }}/js/cs/glide.custom.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/cs/charts.extend.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/pages/dashboard.default.js"></script>

    <script src="{{ asset('public/absensi/new/') }}/js/common.js"></script>
    <script src="{{ asset('public/absensi/new/') }}/js/scripts.js"></script>
    
    <script src="{{ asset('public/absensi/new/') }}/js/vendor/bootstrap-notify.min.js"></script>
    <script src="{{ asset('public/absensi/new/') }}/js/plugins/notifies.js"></script>
