    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <img src="{{ asset('public/logo/sima.png') }}" width="450">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('login') }}"
                                    class="underline text-gray-900 dark:text-white" style="text-decoration: none">Login
                                    SIAP</a></div>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('f_module') }}"
                                    class="underline text-gray-900 dark:text-white"
                                    style="text-decoration: none">Module</a></div>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke="#ffffff"
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('cek_dokumen') }}"
                                    class="underline text-gray-900 dark:text-white" style="text-decoration: none">Cek
                                    Dokumen</a></div>
                        </div>
                    </div>
                    {{-- <div class="p-6">
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                ...
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <div>Powered By PT Indonesian Tobacco Tbk.</div>
                    </div>
                </div>

                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    {{-- Build v{{ Illuminate\Foundation\Application::VERSION }} --}}
                    Developer by IT Build v{!! env('BUILD_VERSION') !!}
                </div>
            </div>
        </div>
    </div>
