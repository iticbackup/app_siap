                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ route('users.create') }}" class="btn btn-outline-primary"><i class="fas fa-plus"></i> Create New User</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-items">
                                            <a class="btn btn-outline-info" href="{{ route('users.show', $item->id) }}"><i class="far fa-eye"></i> Detail</a>
                                            <a class="btn btn-outline-warning" href="{{ route('users.edit', $item->id) }}"><i class="far fa-edit"></i> Edit</a>
                                            <form action="{{ route('users.destroy',$item->id) }}" method="DELETE">
