                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dataTable mb-0">
                            ...
                            <tbody>
                                ...
                                @php
                                    $absens = $fin_pro->where('scan_date', 'LIKE', '%'.date('Y-m-d').'%')
                                                        // ->whereTime('scan_date','<=','11:59:59')
                                                        // ->orWhereTime('scan_date','>=','12:00:00')
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle">{{ $biodata_karyawan->nama_departemen }}</td>
                                    <td class="text-center" style="vertical-align: middle">{{ $biodata_karyawan->nama_posisi }}</td>
                                    @forelse ($absens as $absen)
                                    <td class="text-center" style="vertical-align: middle">{{ \Carbon\Carbon::create($absen->scan_date)->format('H:i') }}</td>
                                    @empty
                                    <td class="text-center" style="vertical-align: middle; color: red">Belum Absen</td>
                                    @endforelse
                                </tr>
                                @endforeach
                            </tbody>
