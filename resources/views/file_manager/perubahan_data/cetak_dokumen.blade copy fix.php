                ...
                <td>
                    <div class="content">
                        <div>Pada hari
                            ...
                            mohon untuk diadakan perubahan informasi terdokumentasi sebagai berikut:</div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($file_manager_perubahan_data_details as $key => $file_manager_perubahan_data_detail)
                                        <tr>
                                            ...
                                            <td class="td text-center">
                                                {{ $file_manager_perubahan_data_detail->no_dokumen }}</td>
                                            <td class="td text-center">
                                                {{ $file_manager_perubahan_data_detail->halaman }}</td>
                                            <td class="td text-center">{{ $file_manager_perubahan_data_detail->revisi }}
                                            </td>
                                            <td class="td" style="width: 250px; word-break: break-all;">
                                                {!! $file_manager_perubahan_data_detail->uraian_perubahan !!}</td>
                                            <td class="td text-center">
            ...
            <tr>
                ...
                <td style="font-size: 8pt">
                    ...
                    <div>Berkas ini telah diverifikasi secara SAH oleh sistem tanggal
                        {{ \Carbon\Carbon::create($file_manager_perubahan_data->created_at)->isoFormat('LL') }}</div>
                </td>
            </tr>
        </table>
    </div>
