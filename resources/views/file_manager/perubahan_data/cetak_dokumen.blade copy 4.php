...
<head>
    ...
    <style>
        ...
        @page{
            ...
            @bottom-left { content: element(footerblock); };
        }
        @media print {
            .count-page::after {
        ...
        <div class="repeatable">
            <div class="">
                <table class="table">
                    ...
                    <tr>
                        <td colspan="2" class="text-bold" style="font-size: 11pt; width: 80px;">Revisi</td>
                        <td class="text-bold" style="font-size: 11pt; width: 100px">: 4</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" class="text-bold" style="font-size: 11pt; width: 80px;">Halaman</td>
                        <td class="text-bold" style="font-size: 11pt; width: 100px">: <span class="count-page"></span></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="text-bold" style="font-size: 11pt; width: 80px;">Tanggal</td>
                        <td class="text-bold" style="font-size: 11pt; width: 100px">: 31/01/2020</td>
                    </tr>
                </table>
            </div>
        </div>

        <div class="page" style="position: absolute; margin-top: 8%">
