        ...
        <tbody>
            ...
            @endphp
                ...
                <tr>
                    ...
                    <td style="text-align: center; border: 1px solid black; vertical-align: top">{{ $hrga_biodata_karyawan->no_bpjs_ketenagakerjaan }}</td>
                    <td style="text-align: center; border: 1px solid black; vertical-align: top">{{ $hrga_biodata_karyawan->no_bpjs_kesehatan }}</td>
                    <td style="text-align: center; border: 1px solid black; vertical-align: top">{{ number_format($hrga_biodata_karyawan->no_rekening_mandiri,0,',','.') }}</td>
                    <td style="text-align: center; border: 1px solid black; vertical-align: top">{{ number_format($hrga_biodata_karyawan->no_rekening_bws,0,',','.') }}</td>
