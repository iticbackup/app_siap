    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('kpi_input_date_kpi_simpan',['departemen_id' => $departemen_id, 'date' => $date]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    @php
                        ...
                        $mengetahui = \App\Models\DepartemenUser::select('team')
                            ...
                            ->first();
                        $penilais = \App\Models\KpiTeam::where('kpi_departemen_id', $kpi_team->kpi_departemen_id)
                                                        ->where('status','y')
                                                        ->get();
                    @endphp
                    <div class="mb-3">
