            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-outline-primary" style="width: 100%" role="alert">
                        <strong>Informasi!</strong> Tanggal pengumpulan KPI terakhir tanggal <b>{{ \Carbon\Carbon::create($date)->isoFormat('dddd, DD MMMM YYYY') }}</b>
                    </div>
                    @foreach ($kpi_teams as $key_1 => $kpi_team)
                    @php
                        $kpi_indikators = \App\Models\KpiIndikator::where('kpi_team_id',$kpi_team->id)->get();
                        $mengetahui = \App\Models\DepartemenUser::select('team')->where('team','Andre Martinus')->first();
                    ...
                    <div class="mb-3">
                        <table style="width: 30%">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="hidden" name="kpi_team_id[]" value="{{ $kpi_team->id }}" id="">
                                    <input type="text" name="yang_dinilai[]" class="form-control" value="{{ $kpi_team->departemen_user->team }}" readonly id="">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="text" class="form-control" value="{{ $kpi_team->jabatan }}" readonly id="">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="text" value="{{ $kpi_team->departemen_user->nik }}" class="form-control" id="" readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="text" value="{{ $periode->isoFormat('MMMM YYYY') }}" readonly class="form-control">
                                    <input type="hidden" name="periode[]" value="{{ $periode->format('Y-m-d') }}" readonly class="form-control">
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="mb-3">
                        <table class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <input type="hidden" name="detail_{{ $key_1 }}[]" value="{{ $key_2+1 }}" id="">
                                    <tr>
                                        <td class="text-center">{{ $key_2+1 }}</td>
                                        <td>
                                            {{-- {{ $kpi_indikator->indikator }} --}}
                                            <textarea name="indikator_{{ $key_1 }}[]" class="form-control" id="" cols="20" rows="5" readonly>{{ $kpi_indikator->indikator }}</textarea>
                                        </td>
                                        <td><input type="text" name="target_nilai_{{ $key_1 }}[]" class="form-control text-center" placeholder="Nilai" id=""></td>
                                        <td><textarea name="target_keterangan_{{ $key_1 }}[]" class="form-control" id="" cols="2" rows="3"></textarea></td>
                                        <td><input type="text" name="realisasi_nilai_{{ $key_1 }}[]" class="form-control text-center" placeholder="Nilai" id=""></td>
                                        <td><textarea name="realisasi_keterangan_{{ $key_1 }}[]" class="form-control" id="" cols="2" rows="3"></textarea></td>
                                        <td><input type="text" name="pencapaian_{{ $key_1 }}[]" class="form-control text-center" placeholder="Pencapaian" id=""></td>
                                        <td class="text-center">
                                            {{ $kpi_indikator->bobot }}%
                                            <input type="hidden" name="bobot_{{ $key_1 }}[]" value="{{ $kpi_indikator->bobot }}" id="">
                                        </td>
                                        {{-- <td></td>
                                        <td></td> --}}
                                        <td><textarea name="keterangan_{{ $key_1 }}[]" class="form-control" id="" cols="2" rows="3"></textarea></td>
                                    </tr>
                                @empty
                                    <tr>
                        ...
                        <table class="table table-bordered dt-responsive nowrap"
                            ...
                            <thead>
                                ...
                                <tr>
                                    <td class="text-center">
                                        {{ $mengetahui->team }}
                                        <input type="hidden" name="mengetahui[]" value="{{ $mengetahui->team }}" id="">
                                    ...
                                    <td class="text-center">
                                        <select name="penilai[]" class="form-control" id="" required>
                                            ...
                                            @foreach ($penilais as $penilai)
                                                ...
                                                <option value="{{ $penilai->departemen_user->team }}">{{ $penilai->departemen_user->team }}</option>
                                                @endif
                                            @endforeach
                                            @endif
                                        </select>
