...
@section('title')
    Rekap Pelatihan Seminar - Kategori
@endsection
@section('css')
...
@section('content')
    ...
    @include('rekap_pelatihan.kategori.modalBuat')
    @include('rekap_pelatihan.kategori.modalEdit')
...
@section('script')
    ...
    <script>
        ...
        var table = $('#datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('rekap_pelatihan.kategori') }}",
            columns: [
                {
                    data: 'kategori',
                    name: 'kategori'
        ...
        $('#form-simpan').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('rekap_pelatihan.kategori_simpan') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        function edit(id) {
            $.ajax({
                type:'GET',
                url: "{{ url('rekap_pelatihan/kategori/') }}"+'/'+id+'',
                contentType: "application/json;  charset=utf-8",
                cache: false,
                success: (result) => {
                    if(result.success == true){
                        $('#edit_id').val(result.data.id);
                        $('#edit_kategori').val(result.data.kategori);
        ...
        $('#form-update').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ route('rekap_pelatihan.kategori_update') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: (result) => {
        ...
        function hapus(id) {
            $.ajax({
                type:'GET',
                url: "{{ url('rekap_pelatihan/kategori/') }}"+'/'+id+'/delete',
                contentType: "application/json;  charset=utf-8",
                cache: false,
                success: (result) => {
                    if(result.success != false){
