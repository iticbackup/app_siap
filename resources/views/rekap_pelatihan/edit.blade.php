    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-outline-primary" role="alert">
                <strong>Pemberitahuan!</strong> Perubahan data maksimal tanggal <b>{{ \Carbon\Carbon::create($start_date)->subDays(1)->isoFormat('LL') }}</b> sebelum acara dimulai.
            </div>
            <div class="card">
                <form id="form-update" method="post">
                    ...
                    <div class="card-body bootstrap-select-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="tema" value="{{ $rekap_pelatihan->tema }}"
                                                class="form-control" placeholder="Tema Seminar / Pelatihan">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Penyelenggara</label>
                                            <input type="text" name="penyelenggara" value="{{ $rekap_pelatihan->penyelenggara }}"
                                                class="form-control" placeholder="Penyelenggara">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="jenis" class="form-control" id="">
                                                ...
                                                @foreach ($rekap_kategoris as $rk)
                                                    <option value="{{ $rk->kategori }}"
                                                        {{ $rk->kategori == $rekap_pelatihan->jenis ? 'selected' : null }}>
                                                        {{ $rk->kategori }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="kategori_pelatihan" class="form-control" id="">
                                                ...
                                                <option value="Internal" {{ $rekap_pelatihan->kategori_pelatihan == 'Intenal' ? 'selected' : null }}>Internal</option>
                                                <option value="Eksternal" {{ $rekap_pelatihan->kategori_pelatihan == 'Eksternal' ? 'selected' : null }}>Eksternal</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Total Jumlah Peserta</label>
                                        <input type="text" name="total_peserta" value="{{ $rekap_pelatihan->total_peserta }}" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Jumlah Hari Pelatihan</label>
                                        <input type="text" name="jml_hari" value="{{ $rekap_pelatihan->jml_hari }}"
                                            class="form-control jml_hari">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Jumlah Jam Pelatihan 1 Hari</label>
                                        <input type="text" name="jml_jam_dlm_hari" value="{{ $rekap_pelatihan->jml_jam_dlm_hari }}"
                                            class="form-control jml_jam_dlm_hari">
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <table id="datatables" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $rekap_pelatihan_peserta->peserta }}</td>
                                            <td>
                        ...
                        <a href="{{ route('rekap_pelatihan.rekap_pelatihan') }}" class="btn btn-secondary">Back</a> --}}
                    </div>
