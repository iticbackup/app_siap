                                ...
                                <div id="flush-collapse{{ $key_ibprpp + 1 }}" class="accordion-collapse collapse"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            {{-- @dd($ibprpp->ibprpp_departemen) --}}
                                            <a href="{{ route('qhse.ibprpp.departemen_edit',['periode' => $ibprpp->ibprpp_periode->periode, 'departemen_id' => $ibprpp->ibprpp_departemen->id, 'id' => $ibprpp->id ]) }}" class="btn btn-warning"><i class="mdi mdi-pencil-outline"></i> Edit</a>
                                            <button type="button" data-id="{{ $ibprpp->id }}" class="btn btn-danger btn-delete"><i class="mdi mdi-trash-can-outline"></i> Hapus</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        ...
        $('.btn-delete').click(function(){
            ...
            $.ajax({
                type: 'delete', 
                url: '{{ route("qhse.ibprpp.departemen_delete",["periode" => $periode->periode, "departemen_id" => $departemen_id ]) }}', 
                data: { 
                    id: id
                },
                beforeSend: function() {
                ...
                success: function(response){
                    ...
                    if (response.success != false) {
                        ...
                        setTimeout(() => {
                            window.location.href="{{ route('qhse.ibprpp.departemen_preview',['periode' => $periode->periode, 'departemen_id' => $departemen_id]) }}"
                        }, 3000);
                    }else{
                        iziToast.error({
