                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="repeater-penilaian-risiko">
                                                        ...
                                                        <div data-repeater-item="">
                                                            <div class="card">
                                                                <div class="card-header bg-dark">
                                                                    <div class="row align-items-center">
                                                                        <div class="col">
                                                                            <h5 class="card-title text-white">+ Penilaian
                                                                                Risiko
                                                                            </h5>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="repeater-penilaian-risiko-risiko-bahaya">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary"
                                                                            data-repeater-create><i
                                                                                class="fas fa-plus"></i> Tambah Risiko Bahaya</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-repeater-create><i
                                                            class="fas fa-plus"></i> Tambah Penilaian Resiko</button>
                                                            <hr style="border-top: 1px dashed blue;">
                                                </div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="pengendalian_upaya"
                                                                            class="form-control"
                                                                            placeholder="Upaya Pengendalian">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            name="pengendalian_penilaian"
                                                                            class="form-control"
                                                                            placeholder="Penilaian Pengendalian">
                                                                    </div>
                                                                    <button type="button" class="btn btn-primary"
                                                                    data-repeater-create><i
                                                                        class="fas fa-plus"></i> Tambah Pengendalian</button>
                                                                    <hr style="border-top: 1px dashed blue;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div data-repeater-item="">
                                                            <div class="card">
                                                                <div class="card-header bg-dark">
                                                                    <div class="row align-items-center">
                                                                        <div class="col">
                                                                            <h5 class="card-title text-white">+ PIC /
                                                                                Wewenang</h5>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                            <button type="button" class="btn btn-success"
                                                        ...
                                                        <div data-repeater-item="">
                                                            <div class="card">
                                                                <div class="card-header bg-dark">
                                                                    <div class="row align-items-center">
                                                                        <div class="col">
                                                                            <h5 class="card-title text-white">+ Regulasi
                                                                                Terkait</h5>
                                                                        </div>
                                                                        <div class="col-auto">
                                                                            <button type="button" class="btn btn-success"
        ...
        $(document).ready(function() {
            ...
            $('.repeater-penilaian').repeater({
                repeaters: [{
                        ...
                        repeaters: [{
                            selector: '.repeater-penilaian-risiko-risiko-bahaya',
                            show: function() {
                                $(this).slideDown();
                            },
                            hide: function(remove) {
