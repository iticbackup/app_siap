...
Route::group(['middleware' => ['auth', 'LogVisits']], function() {
    ...
    Route::prefix('hrga')->group(function () {
        Route::prefix('biodata_karyawan')->group(function () {
            ...
            Route::post('transferKaryawanJeda/simpan', [App\Http\Controllers\HRGAController::class, 'transferKaryawanJedaSimpan'])->name('hrga.biodata_karyawan.transferKaryawanJedaSimpan');
