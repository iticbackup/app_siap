...
class TestingController extends Controller
{
    ...
    public function testing2(Request $request)
    {
        ...
        $barcode = \Storage::disk('barcode')->put('barcode.png',base64_decode(DNS2D::getBarcodePNG("Dokumen telah diverifikasi oleh DCC pada tanggal ".Carbon::create('2024-02-23')->isoFormat('dddd, D MMMM YYYY')." dan MR pada tanggal ".Carbon::create('2024-02-23')->isoFormat('dddd, D MMMM YYYY'), "QRCODE", 6,6)));
        ImageWatermarker::input(public_path('berkas/08 - IT.PCH.PK.08 - PENILAIAN DAN EVALUASI PENYEDIA EKSTERNAL (23-02-24).pdf'))
